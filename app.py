...
def local_css():
    ...
    <style>
        ...
        /* INPUTS MEJORADOS PARA LOGIN */
        input {
            text-align: center; /* Texto centrado en login */
...
def check_auth():
    ...
    with c2:
        ...
        # Creamos 3 sub-columnas para forzar el logo al centro
